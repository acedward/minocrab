...
| `minocrab-std/src/v3.rs` | 2947 | every differential; v3_leaves / v3_bounded / v3_literals / v3_secp; lean_claims (the typed-leaf claims, crates/minocrab-std/lean). `from_field_unchecked` sites: **READING** (the grep in TRUST.md §3) | a leaf whose type promises a bound its constructor did not constrain |
...
31118 lines in the seven crates; 11960 of them in files whose warrant is READING in whole or in part (the rows in bold).
<!-- GENERATED END -->
