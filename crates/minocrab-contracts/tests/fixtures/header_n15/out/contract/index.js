...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      wFirst: async (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`wFirst: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const v_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('wFirst',
                                     'argument 1 (as invoked from Typescript)',
                                     'header_n15.compact line 53 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = await this._wFirst_0(context, partialProofData, v_0);
      ...
      bump: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('bump',
                                     'argument 1 (as invoked from Typescript)',
                                     'header_n15.compact line 57 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = __compactRuntime.copyCircuitContext(contextOrig_0);
      ...
      credit: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('credit',
                                     'argument 1 (as invoked from Typescript)',
                                     'header_n15.compact line 61 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(k_0) === 'bigint' && k_0 >= 0n && k_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('credit',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'header_n15.compact line 61 char 1',
                                     'Uint<0..18446744073709551616>',
  ...
  async initialState(...args_0) {
    ...
    state_0.setOperation('wFirst', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(0n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_3.toValue(new Uint8Array([109, 105, 112, 45, 48, 48, 57, 57, 58, 108, 101, 100, 103, 101, 114, 45, 104, 101, 97, 100, 101, 114, 91, 118, 49, 93, 0, 0, 0, 0, 0, 0])),
                                                                                              alignment: _descriptor_3.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  async _wFirst_0(context, partialProofData, v_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'header_n15.compact line 47 char 1',
                                     'Uint<0..18446744073709551616>',
                                     key_0)
        }
        return _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
