...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      wLast: async (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`wLast: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const v_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('wLast',
                                     'argument 1 (as invoked from Typescript)',
                                     'header_n16.compact line 53 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = await this._wLast_0(context, partialProofData, v_0);
        partialProofData.output = { value: [], alignment: [] };
        __compactRuntime.finalizeCallProofData(context, partialProofData);
        return { result: result_0, context: context, gasCost: context.callContext.currentGasCost };
      }
    };
    this.impureCircuits = { wLast: this.circuits.wLast };
    this.provableCircuits = { wLast: this.circuits.wLast };
  }
  async initialState(...args_0) {
    ...
    state_0.setOperation('wLast', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(0n),
                                                                                              alignment: _descriptor_6.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(new Uint8Array([109, 105, 112, 45, 48, 48, 57, 57, 58, 108, 101, 100, 103, 101, 114, 45, 104, 101, 97, 100, 101, 114, 91, 118, 49, 93, 0, 0, 0, 0, 0, 0])),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
  ...
  async _wLast_0(context, partialProofData, v_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
